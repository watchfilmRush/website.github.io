...
function goToUrl() {
    ...
    if ("" == t)
        ...
        window.location.assign("http://store.steampowered.com/search")
    else if (":ts" == t)
        window.prompt("Server TeamSpeak3", "fr3.ts3x.cx:11167")
    else if (name == t)
        window.location.assign(website)
    else if (":version" == t || ":vv" == t || ":v." == t)
        alert("This Website is in beta, for any errors contact Jupp, thank you!\nVersion 1.51 Beta")
    else
